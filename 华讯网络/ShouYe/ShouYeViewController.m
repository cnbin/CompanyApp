...
static NSString *CellIdentifier = @"ShouYeTableCellIdentifier";
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ShouYeTableViewCell class] forCellReuseIdentifier:CellIdentifier];
